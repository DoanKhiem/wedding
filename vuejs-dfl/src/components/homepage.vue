                                        ...
                                        <li class="yamm-content">
                                            <div class="row">
                                                ...
                                                <div class="dropdown-banner-holder"> <a href="#"><img alt=""
                                                            src="src/assets/images/banners/banner-side.png" /></a> </div>
                                            </div>
                                            <!-- /.row -->
                                        </li>
                                        <!-- /.yamm-content -->
                ...
                <div class="col-xs-12 col-sm-12 col-md-9">
                    <div id="hero">
                        <div id="owl-main" class="owl-carousel owl-inner-nav owl-ui-sm">
                            <div class="item" style="background-image: url(src/assets/images/sliders/02.jpg);">
                                <div class="container-fluid">
                                    <div class="caption bg-color vertical-center text-left">
                                        <div class="slider-header fadeInDown-1">Top Brands 2018</div>
                                        <div class="big-text fadeInDown-1">Digital <span class="highlight">Watch</span>
                                        </div>
                                        <div class="excerpt fadeInDown-2 hidden-xs"> <span>Get 50% off on selected
                                                items</span> </div>
                            ...
                            <div class="item" style="background-image: url(src/assets/images/sliders/01.jpg);">
                                <div class="container-fluid">
                                    <div class="caption bg-color vertical-center text-left">
                                        <div class="slider-header fadeInDown-1">Spring 2018</div>
                                        <div class="big-text fadeInDown-1"> Modern <span class="highlight">Chair</span>
                                        </div>
                                        <div class="excerpt fadeInDown-2 hidden-xs"> <span>Nemo enim ipsam voluptatem quia
                                                <br> voluptas sit aspernatur.</span> </div>
                                        <div class="button-holder fadeInDown-3"> <a
                                                href="index6c11.html?page=single-product"
                                                class="btn-lg btn btn-uppercase btn-primary shop-now-button">Shop Now</a>
                                        </div>
                ...
                <div class="row">
                    <div class="col-md-6 col-sm-6">
                        <div class="wide-banner cnt-strip">
                            <div class="image"> <img class="img-responsive" src="src/assets/images/banners/home-banner1.jpg"
                                    alt=""> </div>
                        </div>
                        <!-- /.wide-banner -->
                    </div>
                    ...
                    <div class="col-md-6 col-sm-6">
                        <div class="wide-banner cnt-strip">
                            <div class="image"> <img class="img-responsive" src="src/assets/images/banners/home-banner2.jpg"
                                    alt=""> </div>
                        </div>
                        <!-- /.wide-banner -->
                    </div>
                                        ...
                                        <div class="product">
                                            <div class="product-image">
                                                <div class="image"> <a href="detail.html"><img
                                                            src="src/assets/images/products/p5.jpg" alt=""></a> </div>
                                                <!-- /.image -->
                                ...
                                <div class="item item-carousel">
                                    <div class="products">
                                        <div class="product">
                                            <div class="product-image">
                                                <div class="image"> <a href="detail.html"><img
                                                            src="src/assets/images/products/p6.jpg" alt=""></a> </div>
                                                <!-- /.image -->
                                ...
                                <div class="item item-carousel">
                                    <div class="products">
                                        <div class="product">
                                            <div class="product-image">
                                                <div class="image"> <a href="detail.html"><img
                                                            src="src/assets/images/products/p7.jpg" alt=""></a> </div>
                                                <!-- /.image -->
                                ...
                                <div class="item item-carousel">
                                    <div class="products">
                                        <div class="product">
                                            <div class="product-image">
                                                <div class="image"> <a href="detail.html"><img
                                                            src="src/assets/images/products/p8.jpg" alt=""></a> </div>
                                                <!-- /.image -->
                                ...
                                <div class="item item-carousel">
                                    <div class="products">
                                        <div class="product">
                                            <div class="product-image">
                                                <div class="image"> <a href="detail.html"><img
                                                            src="src/assets/images/products/p9.jpg" alt=""></a> </div>
                                                <!-- /.image -->
                                ...
                                <div class="item item-carousel">
                                    <div class="products">
                                        <div class="product">
                                            <div class="product-image">
                                                <div class="image"> <a href="detail.html"><img
                                                            src="src/assets/images/products/p10.jpg" alt=""></a> </div>
                                                <!-- /.image -->
                                ...
                                <div class="item item-carousel">
                                    <div class="products">
                                        <div class="product">
                                            <div class="product-image">
                                                <div class="image"> <a href="detail.html"><img
                                                            src="src/assets/images/products/p11.jpg" alt=""></a> </div>
                                                <!-- /.image -->
                                ...
                                <div class="item item-carousel">
                                    <div class="products">
                                        <div class="product">
                                            <div class="product-image">
                                                <div class="image"> <a href="detail.html"><img
                                                            src="src/assets/images/products/p12.jpg" alt=""></a> </div>
                                                <!-- /.image -->
                                ...
                                <div class="item item-carousel">
                                    <div class="products">
                                        <div class="product">
                                            <div class="product-image">
                                                <div class="image"> <a href="detail.html"><img
                                                            src="src/assets/images/products/p13.jpg" alt=""></a> </div>
                                                <!-- /.image -->
                                ...
                                <div class="item item-carousel">
                                    <div class="products">
                                        <div class="product">
                                            <div class="product-image">
                                                <div class="image"> <a href="detail.html"><img
                                                            src="src/assets/images/products/p14.jpg" alt=""></a> </div>
                                                <!-- /.image -->
                                ...
                                <div class="item item-carousel">
                                    <div class="products">
                                        <div class="product">
                                            <div class="product-image">
                                                <div class="image"> <a href="detail.html"><img
                                                            src="src/assets/images/products/p15.jpg" alt="image"></a> </div>
                                                <!-- /.image -->
                                ...
                                <div class="item item-carousel">
                                    <div class="products">
                                        <div class="product">
                                            <div class="product-image">
                                                <div class="image"> <a href="detail.html"><img
                                                            src="src/assets/images/products/p16.jpg" alt=""></a> </div>
                                                <!-- /.image -->
                                ...
                                <div class="item item-carousel">
                                    <div class="products">
                                        <div class="product">
                                            <div class="product-image">
                                                <div class="image"> <a href="detail.html"><img
                                                            src="src/assets/images/products/p18.jpg" alt=""></a> </div>
                                                <!-- /.image -->
                                ...
                                <div class="item item-carousel">
                                    <div class="products">
                                        <div class="product">
                                            <div class="product-image">
                                                <div class="image"> <a href="detail.html"><img
                                                            src="src/assets/images/products/p17.jpg" alt=""></a> </div>
                                                <!-- /.image -->
                                            ...
                                            <div class="item-inner">
                                                <div class="item-img">
                                                    <div class="item-img-info">
                                                        <div class="link-quickview"><a href="#" class="quick-view"><i
                                                        ...
                                                        <a class="product-image" title="Retis lapen casen"
                                                            href="product_detail.html"> <img
                                                                src="src/assets/images/products/p20.jpg" alt=""> </a>
                                                ...
                                                <div class="item-info">
                                                    <div class="info-inner">
                                                        <div class="item-title"> <a title="Retis lapen casen"
                                                                href="product_detail.html">Floral Print shirt Buttoned</a>
                                                        </div>
                                                        <div class="rating rateit-small"></div>
                                                        <div class="product-item-description">You won't know what you like
                                                            best about the Antonia Racer Tank: soft, stretchy, Super-cute...
                                                        </div>
                                                ...
                                                <div class="category-products">
                                                    <ul class="products-grid">
                                                        <li class="item col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                            <div class="item-inner">
                                                                <div class="item-img">
                                                                    ...
                                                                    <a class="product-image" title="Retis lapen casen"
                                                                        href="product_detail.html"> <img
                                                                            src="src/assets/images/products/p6.jpg" alt="">
                                                                    </a>
                                                                ...
                                                                <div class="item-info">
                                                                    <div class="info-inner">
                                                                        <div class="item-title"> <a
                                                                                ...
                                                                                href="product_detail.html">Floral Print
                                                                                shirt Buttoned</a> </div>
                                                                        <div class="item-content">
                                                                            <div class="item-price">
                                                                                <div class="price-box">
                                                                                    <p class="special-price"> <span
                                                        ...
                                                        <li class="item col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                            <div class="item-inner">
                                                                <div class="item-img">
                                                                    <div style=" display:none;" class="product-cartitem">0
                                                                    </div>
                                                                    <a class="product-image" title="Retis lapen casen"
                                                                        href="product_detail.html"> <img
                                                                            src="src/assets/images/products/p7.jpg" alt="">
                                                                    </a>
                                                        ...
                                                        <li class="item col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                            <div class="item-inner">
                                                                <div class="item-img">
                                                                    ...
                                                                    <a class="product-image" title="Retis lapen casen"
                                                                        href="product_detail.html"> <img
                                                                            src="src/assets/images/products/p8.jpg" alt="">
                                                                    </a>
                                                        ...
                                                        <li class="item col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                            <div class="item-inner">
                                                                <div class="item-img">
                                                                    ...
                                                                    <a class="product-image" title="Retis lapen casen"
                                                                        href="product_detail.html"> <img
                                                                            src="src/assets/images/products/p9.jpg" alt="">
                                                                    </a>
                                                        ...
                                                        <li class="item col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                            <div class="item-inner">
                                                                <div class="item-img">
                                                                    ...
                                                                    <a class="product-image" title="Retis lapen casen"
                                                                        href="product_detail.html"> <img
                                                                            src="src/assets/images/products/p10.jpg" alt="">
                                                                    </a>
                                                        ...
                                                        <li class="item col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                            <div class="item-inner">
                                                                <div class="item-img">
                                                                    ...
                                                                    <a class="product-image" title="Retis lapen casen"
                                                                        href="product_detail.html"> <img
                                                                            src="src/assets/images/products/p14.jpg" alt="">
                                                                    </a>
                                                        ...
                                                        <li class="item col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                            <div class="item-inner">
                                                                <div class="item-img">
                                                                    <a class="product-image" title="Retis lapen casen"
                                                                        href="product_detail.html"> <img
                                                                            src="src/assets/images/products/p2.jpg" alt="">
                                                                    </a>
                                                                </div>
                                                                <div class="item-info">
                                                                    <div class="info-inner">
                                                        ...
                                                        <li class="item col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                            <div class="item-inner">
                                                                <div class="item-img">
                                                                    <a class="product-image" title="Retis lapen casen"
                                                                        href="product_detail.html"> <img
                                                                            src="src/assets/images/products/p1.jpg" alt="">
                                                                    </a>
                                                        ...
                                                        <li class="item col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                            <div class="item-inner">
                                                                <div class="item-img">
                                                                    <a class="product-image" title="Retis lapen casen"
                                                                        href="product_detail.html"> <img
                                                                            src="src/assets/images/products/p4.jpg" alt="">
                                                                    </a>
                                                        ...
                                                        <li class="item col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                            <div class="item-inner">
                                                                <div class="item-img">
                                                                    <a class="product-image" title="Retis lapen casen"
                                                                        href="product_detail.html"> <img
                                                                            src="src/assets/images/products/p3.jpg" alt="">
                                                                    </a>
                                                            ...
                                                            <li class="item col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                <div class="item-inner">
                                                                    <div class="item-img">
                                                                        ...
                                                                        <a class="product-image" title="Retis lapen casen"
                                                                            href="product_detail.html"> <img
                                                                                src="src/assets/images/products/p11.jpg"
                                                                                alt="">
                                                                        </a>
                                                            ...
                                                            <li class="item col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                <div class="item-inner">
                                                                    <div class="item-img">
                                                                        <a class="product-image" title="Retis lapen casen"
                                                                            href="product_detail.html"> <img
                                                                                src="src/assets/images/products/p15.jpg"
                                                                                alt="">
                                                                        </a>
                                                            ...
                                                            <li class="item col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                <div class="item-inner">
                                                                    <div class="item-img">
                                                                        <a class="product-image" title="Retis lapen casen"
                                                                            href="product_detail.html"> <img
                                                                                src="src/assets/images/products/p9.jpg"
                                                                                alt="">
                                                                        </a>
                                                            ...
                                                            <li class="item col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                <div class="item-inner">
                                                                    <div class="item-img">
                                                                        ...
                                                                        <a class="product-image" title="Retis lapen casen"
                                                                            href="product_detail.html"> <img
                                                                                src="src/assets/images/products/p10.jpg"
                                                                                alt="">
                                                                        </a>
                                                            ...
                                                            <li class="item col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                <div class="item-inner">
                                                                    <div class="item-img">
                                                                        ...
                                                                        <a class="product-image" title="Retis lapen casen"
                                                                            href="product_detail.html"> <img
                                                                                src="src/assets/images/products/p5.jpg"
                                                                                alt="">
                                                                        </a>
                                                            ...
                                                            <li class="item col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                <div class="item-inner">
                                                                    <div class="item-img">
                                                                        ...
                                                                        <a class="product-image" title="Retis lapen casen"
                                                                            href="product_detail.html"> <img
                                                                                src="src/assets/images/products/p3.jpg"
                                                                                alt="">
                                                                        </a>
                ...
                <div class="owl-carousel home-owl-carousel custom-carousel owl-theme outer-top-xs">
                    <div class="item item-carousel">
                        <div class="products">
                            <div class="product">
                                <div class="product-image">
                                    <div class="image"> <a href="detail.html"><img src="src/assets/images/products/p5.jpg"
                                                alt=""></a> </div>
                                    <!-- /.image -->
                    ...
                    <div class="item item-carousel">
                        <div class="products">
                            <div class="product">
                                <div class="product-image">
                                    <div class="image"> <a href="detail.html"><img src="src/assets/images/products/p2.jpg"
                                                alt=""></a> </div>
                                    <!-- /.image -->
                    ...
                    <div class="item item-carousel">
                        <div class="products">
                            <div class="product">
                                <div class="product-image">
                                    <div class="image"> <a href="detail.html"><img src="src/assets/images/products/p6.jpg"
                                                alt=""></a> </div>
                                    <!-- /.image -->
                    ...
                    <div class="item item-carousel">
                        <div class="products">
                            <div class="product">
                                <div class="product-image">
                                    <div class="image"> <a href="detail.html"><img src="src/assets/images/blank.gif"
                    ...
                    <div class="item item-carousel">
                        <div class="products">
                            <div class="product">
                                <div class="product-image">
                                    <div class="image"> <a href="detail.html"><img src="src/assets/images/products/p8.jpg"
                                                alt=""></a> </div>
                                    <!-- /.image -->
                    ...
                    <div class="item item-carousel">
                        <div class="products">
                            <div class="product">
                                <div class="product-image">
                                    <div class="image"> <a href="detail.html"><img src="src/assets/images/products/p9.jpg"
                                                alt=""></a> </div>
                                    <!-- /.image -->
                    ...
                    <div class="item item-carousel">
                        <div class="products">
                            <div class="product">
                                <div class="product-image">
                                    <div class="image"> <a href="detail.html"><img src="src/assets/images/products/p10.jpg"
                                                alt=""></a> </div>
                                    <!-- /.image -->
                ...
                <div class="logo-slider-inner">
                    <div id="brand-slider" class="owl-carousel brand-slider custom-carousel owl-theme">
                        <div class="item"> <a href="#" class="image"> <img data-echo="assets/images/brands/brand1.png"
                                    src="src/assets/images/blank.gif" alt=""> </a> </div>
                        <!--/.item-->
